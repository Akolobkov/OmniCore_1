...
def create_file(filename: str, content: str) -> str:
    ...
    Important: THE FILE NAME AND TOOL FUNCTION NAME INSIDE MUST BE THE SAME!!!
    ...
    try:
        ...
        return f"File with such name already exists: {filename}. Tool creation failed. Use 'write_to_file' to write into existing file instead!"
    except FileNotFoundError:
        #when trying to create an unexisting folder
        try:
